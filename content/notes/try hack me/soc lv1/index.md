1. [Cyber Defence Frameworks](https://tryhackme.com/module/cyber-defence-frameworks)
    ...
    5. [Diamond Model](<5-Diamond_Model.md>)
    6. [MITRE](6-MITRE.md)
    7. [summit](https://tryhackme.com/room/summit)
    8. [Eviction](https://tryhackme.com/room/eviction) 
2. [Cyber Threat Intelligence](https://tryhackme.com/module/cyber-threat-intelligence)
    ...
    3. [yara](<3-yara.md>)
    4. [Open CTI](<4-OpenCTI.md>)
    5. [MISP](<5-MISP.md>)
    6. [Friday Overtime](<6-fridayovertime.md>)
    7. [Trooper](<7-trooper.md>)

3. [Network Security and Traffic Analysis](<3 Network Security and Traffic Analysis>)
    1. [Traffic Analysis Essentials](<1-Traffic Analysis Essentials.md>)
    2. [Snort](<2-Snort.md>)
4. [Endpoint Security Monitoring](<4 Endpoint Security Monitoring>)
    ...
    2. [Core Windows Processes](<2-Core Windows Processes.md>)
    ...
    7. [Wazuh](<4 Endpoint Security Monitoring/7 Wazuh.md>)
    8. [Monday Monitor](<4 Endpoint Security Monitoring/8 Monday Monitor.md>)
    9. [Retracted](<4 Endpoint Security Monitoring/9 Retracted.md>)